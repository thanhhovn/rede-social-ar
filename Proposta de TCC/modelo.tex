...
\begin{tabular}{|p{10cm}|l|c|c|c|c|c|c|c|c|c|}
\hline 
\rule[-1ex]{0pt}{2.3ex} Atividades & Período \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Pesquisa Bibliográfica sobre Geoprocessamento e Realidade Aumentada e
suas técnicas & 01/03/12 a 31/03/2012   \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Escrita da Proposta & 15/03/12 a 30/04/2012    \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Entrega da Proposta & 30/04/2012    \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Defesa da Proposta &  07/11/2012   \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Construção da Aplicação  &  15/06/2012 a 31/03/2013    \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Validar Aplicação  &  20/03/2013 a 31/03/2013    \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Escrita de TCC     &  01/04/2012 a 31/03/2013  \\ 
\hline 
\rule[-1ex]{0pt}{2.5ex} Apresentar Projeto &  Não definido  \\ 
\hline 
\end{tabular} 
%\begin{table}[htbp]
%	\centering
%	\begin{tabular}{|c|c|} \hline
%	\multicolumn{2}{|c|}{Brasil} \\ \hline
%	Estado & Time \\ \hline
%	\multirow{4}{*}{Pesquisa Bibliográfica sobre Geoprocessamento e Realidade Aumentada e suas técnicas} & São Paulo \\ \cline{2-2}
%	& Santos \\ \cline{2-2}
%	& Corinthias \\ \cline{2-2}
%	& Palmeiras \\ \hline
%
%	\multirow{4}{*}{Rio de Janeiro} & Flamengo \\ \cline{2-2}
%	& Botafogo \\ \cline{2-2}
%	& Vasco \\ \cline{2-2}
%	& Fluminense \\ \hline
%\end{tabular}
%\caption{Descrição Total}
%\label{tab:interfaceCallBack}
%\end{table}

 % \begin{figure}[h]
%		\begin{center}
%			\includegraphics{Figuras/Cronograma2.png} 
%			\caption{}
...
\label{RCS}
  \indent \indent
   ...
   \begin{itemize}
   \item	Dispositivo Móvel (smartfhone);
